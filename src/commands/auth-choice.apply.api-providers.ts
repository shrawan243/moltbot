...
export async function applyAuthChoiceApiProviders(
  ...
  if (authChoice === "nebius-api-key") {
    ...
    if (!hasCredential) {
      await params.prompter.note(
        [
          "Nebius provides access to Qwen3 Coder 480B and other models.",
          "Get your API key at: https://console.nebius.com/",
          "Uses the Token Factory API at api.tokenfactory.nebius.com.",
        ].join("\n"),
        "Nebius",
      );
    }
